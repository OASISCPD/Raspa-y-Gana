...
export function TemplateMailDesktop() {
    ...
    return (
        <div ref={firstDivRegex} className=" lg:py-[12rem] 2xl:py-[4rem] sm:mx-[2rem] lg:mx-[8rem] xl:mx-[12rem] 2xl:mx-[20rem] textGothamMedium">
            ...
            <h1 className="text-2xl text-white text-center font-bold sm:text-4xl lg:text-xl xl:text-2xl 2xl:text-4xl">INGRESÁ UNA DIRECCIÓN DE CORREO VÁLIDA <br />
            ...
            <div className="mt-16 lg:my-8 flex justify-center 2xl:my-[4rem]">
                <img src={logo} className="w-[16rem] sm:w-[24rem] xl:w-[30rem] 2xl:w-[32rem]" alt="logo empresarial" />
            </div>
