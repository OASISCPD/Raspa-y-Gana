...
export function TemplateMailMobile() {
    ...
    return (
        <div className="   py-[6rem] textGothamMedium">
            ...
            <h1 ref={firstDivRegex} className="text-2xl font-bold  text-white text-center sm:text-4xl">INGRESÁ UNA DIRECCIÓN DE CORREO VÁLIDA <br />
            ...
            <button
                ...
                className={`${buttonActivated ? 'bg-gradient-to-r from-redMain to-roseMain' : 'bg-redMain bg-opacity-70 text-opacity-70 '} uppercase rounded-3xl p-2 px-[3rem] cursor-pointer  text-white sm:text-xl`}
            >
                Enviar
            </button>
            ...
            <div className=" flex justify-center sm:-mb-[8rem]">
                <img src={logo} className=" sm:w-[24rem]" alt="logo empresarial" />
            </div>
