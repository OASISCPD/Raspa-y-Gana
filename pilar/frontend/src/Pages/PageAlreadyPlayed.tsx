                ...
                >
                    <div className="flex-grow flex flex-col justify-center py-24 textGothamMedium">
                        ...
                        <div className='flex justify-center items-center'>
                            <button onClick={() => window.open('https://bingopilar.com.ar/')} className='text-white shadow-lg uppercase mt-8 bg-gradient-to-r hover:scale-95 duration-300 from-redMain to-roseMain border-0 py-2 mx-auto sm:mx-[4rem]  hover:bg-yellow-600 rounded-3xl items-center text-lg px-8 sm:px-12 sm:text-2xl lg:text-lg xl:text-xl'>
