                    ...
                    <div className="relative textGothamMedium">
                        ...
                        <div className="relative z-20 mx-[2rem] text-start py-16 sm:py-20 text-white ">
                            ...
                            <ol className='mx-[1rem] sm:mx-[2rem] text-base sm:text-xl'>
                                <li className='my-2'>
                                    1.  La presente promoción en adelante “Raspá y Ganá”, es organizada por Bingo Pilar S.A. (Bingo Oasis) con domicilio en: CALLE RUTA PANAMERICANA, PILAR WALK, Nº: 50,400. Localidad: VILLA ROSA Partido: DEL PILAR CP: 1629. Provincia: BUENOS AIRES
                                ...
                                <li className='my-2'>
                                    6. Mecánica de la promoción. El usuario accederá a marketing.bingopilar.com.ar donde encontrará el juego de “raspá y ganá” con premios disponibles. Todas las jugadas tienen premios. Para poder hacerse beneficiario del premio el usuario debe de manera excluyente ingresar una dirección de correo electrónica válida, donde recibirá el código de su premio. Los premios deberán ser canjeados en el plazo de 4 días desde la generación del correo electrónico con el qr que le ha llegado y el dni del usuario. De lo contrario el beneficio quedará disponible para otro ganador.
                                </li>
                                <li className='my-2'>
                                    7. Sorteo del auto. Se realizará el sorteo de un auto Renault Logan Life 0 km. a través de los cupones adquiridos tanto en el Raspá y Ganá cómo en distintas acciones futuras dentro de la sala. El sorteo a realizarse el miércoles 18 de diciembre de 2024 tendrá un ganador. Los gastos de transferencia corren por cuenta del ganador. El auto se retirará una vez realizada la transferencia y con seguro contratado por el beneficiario.
                                </li>
                                <li className='my-2'>
                            ...
                            <ol className='mx-[1rem] sm:mx-[2rem] text-base sm:text-xl'>
                                ...
                                <li className='my-2'>
                                    <span className='font-bold'>3. 1 TICKET DE $7.500. </span>  Se limitará el canje a 1 ticket válido por el día del canje. No transferible.  Ticket jugable no cobrable, disponible en las máquinas slots habilitadas para tal fin.
                                </li>
                                <li className='my-2'>
                                    <span className='font-bold'>4. 25 CHANCES PARA EL SORTEO DEL AUTO  </span>  No transferible.
                                </li>
                                <li className='my-2'>
                                    <span className='font-bold'>5. 15 CHANCES PARA EL SORTEO DEL AUTO </span>  No transferible.
                                </li>
                            </ol>
