                ...
                >
                    <div className="flex-grow flex flex-col justify-center py-24 textGothamMedium">
                        ...
                        <div className='flex justify-center items-center'>
                            <button onClick={() => window.open('https://maps.app.goo.gl/hjPxXkwXM5oEKFKr5')} className='text-white shadow-lg uppercase mt-8 bg-gradient-to-r from-redMain to-roseMain border-0 py-2 mx-[4rem]  hover:bg-yellow-600 rounded-3xl items-center text-lg px-8 sm:px-12 sm:text-2xl lg:text-lg xl:text-xl'>
                                Cómo llegar
                            </button>
                        </div>
