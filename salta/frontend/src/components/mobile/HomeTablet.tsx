                                    ...
                                    <div className="flex flex-col text-center w-full mb-4 ">
                                       {/*  <img src={imgLogo} className="sm:w-[32rem] mx-auto pb-[2rem] " alt="Titulo Alterno" /> */}
                                        <div className="pt-[3rem] text-center">
                                            <img
                                                src={img}
                                                className=" animate-spin-once w-[36rem] mx-auto"
                                                alt="Titulo Alterno"
                                            />
                                        </div>
                                        <div className='py-[2rem]'>
                                            <img src={imgSubTitle} className="w-[28rem] mx-auto" alt="" />
                                        </div>
                                        ...
                                        <div className='py-[1rem] pb-[4rem]'>
                                            <button onClick={handlePlayScratch} className='rounded-3xl bg-gradient-to-r shadow-2xl shadow-gray-500 from-greenMain to-greenDark text-white py-4 my-4 text-2xl inline-block mx-auto px-[4rem] uppercase '>Jugar</button>
                                        </div>
                                    </div>
