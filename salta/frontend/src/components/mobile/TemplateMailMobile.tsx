...
export function TemplateMailMobile() {
    ...
    return (
        <div ref={firstDivRegex} className="py-[6rem] textGothamMedium">
            ...
            <h1 className="text-2xl font-bold  text-white text-center sm:text-4xl">INGRESÁ UNA DIRECCIÓN DE CORREO VÁLIDA <br />
                PARA QUE TE ENVIEMOS UN MAIL CON TU PREMIO</h1>
            <h2 className="text-gray-200 mb-8 mt-4 sm:my-12  text-sm sm:text-xl">
                Recuerda ingresar tu mail correctamente
                y checkea casilla de SPAM si no lo ves en bandeja de ENTRADA
            </h2>
            <div className="relative flex mt-12 mb-4 items-center">
            ...
            <div className="flex items-center mb-8 sm:mb-12">
                <input
                    ...
                    type="checkbox"
                    checked={isChecked}
                    className="w-4 h-4 sm:w-8 sm:h-8  text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500  focus:ring-2 " required
                />
            ...
            <button
                ...
                className={`${buttonActivated ? 'bg-gradient-to-r from-greenMain to-greenDark' : 'bg-greenDark bg-opacity-50 text-opacity-50 '} uppercase rounded-3xl py-2 sm:py-3 lg:py-2 px-[3rem] cursor-pointer  text-white sm:text-xl`}
            >
                Enviar
            </button>
            ...
            <div className=" flex justify-center sm:my-[2rem]">
                <img src={logo} className="animate-spin-once-logo w-[8rem]  sm:w-[12rem]" alt="logo empresarial" />
            </div>
