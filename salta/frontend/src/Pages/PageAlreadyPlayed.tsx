                ...
                >
                    <div className="flex-grow flex flex-col justify-center py-24 textGothamMedium">
                        ...
                        <div className='flex justify-center items-center'>
                            <button onClick={() => window.open('https://newgaming.com.ar/')} className='text-white shadow-lg uppercase mt-8 bg-gradient-to-r hover:scale-95 duration-300 from-redMain to-roseMain border-0 py-2 mx-auto sm:mx-[4rem]  hover:bg-yellow-600 rounded-3xl items-center text-lg px-8 sm:px-12 sm:text-2xl lg:text-lg xl:text-xl'>
                                Entrar a Casino Alberdi
                            </button>
                        </div>
                        <div className='flex justify-center items-center content-center mt-48 lg:mt-[8rem]'>
                            <img src={logo} alt="Logo Pilar" className='animate-spin-once-logo w-[8rem] sm:w-[20rem] lg:w-[16rem] xl:w-[16rem] 2xl:w-[16rem]' />
                        </div>
                    </div>
                    <Footer whatsapp='https://api.whatsapp.com/send/?phone=5491169392978&text&type=phone_number&app_absent=0' instagram='https://www.instagram.com/nuevocasinoalberdi/' facebook='https://www.facebook.com/nuevocasinoalberdi' />
                </div>
            )}
        </div>
    )
