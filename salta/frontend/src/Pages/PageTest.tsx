    ...
    return (
        <div>
            {imagesLoaded || !minimumTimeElapsed ? (
                ...
                <div>
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Esse unde ducimus nisi iste, eum ab sit explicabo doloremque accusantium nemo asperiores vel magnam nobis at obcaecati praesentium quidem dolorem doloribus.
                    <img src={img1} alt="" />
                    <img src={img2} alt="" />
                    <img src={img3} alt="" />
                    <img src={img4} alt="" />
