                ...
                >
                    <div className="flex-grow mx-[0.5rem] sm:mx-[2rem] lg:mx-[1rem] xl:mx-[2rem]  flex flex-col justify-center py-4 textGothamMedium">
                        ...
                        <div className='flex justify-center items-center my-4'>
                            <button onClick={() => navigate('/')} className='text-white shadow-lg uppercase   bg-gradient-to-r from-greenMain to-greenDark border-0 py-2 mx-[4rem] hover:bg-yellow-600 rounded-3xl items-center text-base px-8 sm:px-12 my-12 sm:text-xl'>
                                Volver al inicio
                            </button>
                        </div>
                        <div className='my-4'>
                        ...
                        <div className='flex justify-center items-center content-center my-4'>
                            <img src={logo} alt="Logo Zarate" className='animate-spin-once-logo w-[8rem] sm:w-[12rem]' />
                        </div>
                    </div>
