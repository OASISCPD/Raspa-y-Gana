...
export function TemplateMailDesktop() {
    ...
    return (
        <div ref={firstDivRegex} className="pt-12 lg:py-[2rem] 2xl:py-[4rem] sm:mx-[2rem] lg:mx-[8rem] xl:mx-[12rem] 2xl:mx-[20rem] textGothamMedium">
            ...
            <div className="mt-16 lg:my-8 flex justify-center 2xl:my-[4rem]">
                <img src={logo} className="w-[16rem] sm:w-[24rem] lg:w-[30rem] 2xl:w-[32rem]" alt="logo empresarial" />
            </div>
